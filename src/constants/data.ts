...
export const works = [
  {name: "", title:'FastApi Dashboard', imgUrl: images.dashboard, description: "Build with react and will fetch the data from a fastapi server", codeLink: 'https://github.com/KcPele/dashboard-react', projectLink: "https://fastapidashboard.vercel.app/", tags: [{tag: "React JS"}, {tag: 'FastApi'}, {tag: "All"}]},
  {name: "", title:'Test Dashboard', imgUrl: images.mainstack, description: "The dashboard was just for an interview test", codeLink: 'https://github.com/KcPele/interview-test', projectLink: "http://maindashboard.vercel.app/", tags: [{tag: "React JS"}, {tag: "Typescript"}, {tag: "All"}]},
  ...
  {name: "", title:'Simple Gallary', imgUrl: images.simplegallary, description: "Dev.io challange", codeLink: 'https://github.com/KcPele/gallery-challenge', projectLink: "https://infallible-bose-b3188d.netlify.app/", tags: [{tag: "HTML/CSS"}, {tag: "All"}]},
  {name: "", title:'Checkout Challange', imgUrl: images.checkout, description: "Dev.io Challange", codeLink: 'https://github.com/KcPele/checkout-challange', projectLink: "https://stoic-brattain-b1f1a7.netlify.app/", tags: [{tag: "HTML/CSS"}, {tag: "All"}]},
  {name: "", title:'GPT3 Open Ai', imgUrl: images.gpt3, description: "Let’s Build Something amazing with GPT-3 Open Ai", codeLink: 'https://github.com/KcPele/gpt3-design', projectLink: "https://gpt3-ai123.netlify.app/", tags: [{tag: "Next Js"}, {tag: "Web Dev"}, {tag: "All"}]},
  {name: "", title:'Portfolio', imgUrl: images.portfoliov1, description: "My old portfolio", codeLink: 'https://github.com/KcPele/django_internship_resume', projectLink: "https://kcpele.herokuapp.com/", tags: [{tag: "Django"}, {tag: "Web Dev"}, {tag: "All"}]},
  {name: "", title:'Taskcy Api', imgUrl: images.taskcyapi, description: "Taskcy todo api", codeLink: 'https://github.com/KcPele/taskcyapi', projectLink: "https://taskcyapi.herokuapp.com/docs", tags: [{tag: "FastApi"}, {tag: "Web App"}, {tag: "All"}]},
  {name: "", title:'Taskcy', imgUrl: images.taskcy, description: "Taskcy Todo app", codeLink: 'https://github.com/KcPele/taskcyTodo', projectLink: "https://taskcy.vercel.app/", tags: [{tag: "React JS"}, {tag: "Typescript"}, {tag: "Web App"}, {tag: "All"}]},
  {name: "", title:'Nibbl.', imgUrl: images.nibble1, description: "Manage your space easily with Nibbl.", codeLink: 'https://github.com/KcPele/nibbl', projectLink: "https://nibbl-eight.vercel.app/", tags: [{tag: "Next Js"}, {tag: "Typescript"}, {tag: "All"}]},
  {name: "", title:'Restuarant Landing Page', imgUrl: images.restaurant, description: "The key to fine dining", codeLink: 'https://github.com/KcPele/restuarant-landing-page', projectLink: "https://restuarant-landing-page.vercel.app/", tags: [{tag: "React JS"}, {tag: "All"}, {tag: "All"}]},
